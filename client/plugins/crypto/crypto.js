...
class Crypto {
  ...
  encryptAES = data => AES.encrypt(JSON.stringify(data), this.AES_SECRET).toString();
  decryptAES = cipherText => JSON.parse(AES.decrypt(cipherText, this.AES_SECRET).toString(CryptoJS.enc.Utf8));
